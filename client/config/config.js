...
.config(function($stateProvider, $urlRouterProvider){
  ...
  .state('albums', {url: '/contacts', templateUrl: '/views/albums/albums.html', abstract: true})
  ...
  .state('albums.preview', {url: '/{album}', templateUrl: '/views/albums/albums-preview.html', controller: 'AlbumsPreviewCtrl'})
